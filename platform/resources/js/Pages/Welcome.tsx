	...
	return (
		<BaseTemplate>
			...
			<div className="flex flex-col justify-center items-center w-screen h-screen">
				<div className="w-2/4 xl:w-2/4 h-2/6 p-4 border border-solid border-black dark:border-white rounded-lg bg-pearl/30 dark:bg-dark-light/60 backdrop-blur">
					<div className="flex flex-col justify-center items-center w-full h-full">
						...
						<p
							className={`mt-2 dark:text-white text-black/80 font-regular text-sm lg:text-base text-center whitespace-pre-line`}
						>
							{cleanQuote}
						</p>
					</div>
